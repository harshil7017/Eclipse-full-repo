package GenerateScreenshot.GenerateScreenshot;
...
ExtentTest logger;
WebDriver driver;
ThreadLocal extent1=new ThreadLocal();
@BeforeTest
...
extent
                ...
                .addSystemInfo("User Name", "Harshil sheth");
...
//To capture screenshot path and store the path of the screenshot in the string "screenshotPath"
                        ...
                        String screenshotPath = AppTest.getScreenhot(driver, result.getName());
